  ...
  return (
    ...
    >
      <section className="flex flex-col flex-grow justify-between pt-[72px] pb-[10vh] px-6 md:px-16 lg:px-24 max-[578px]:px-2 max-[578px]:pb-[17vh]">
            ...
            >
              {["Creative", "Web Developer", "Designer", "Freelancer"].map(
                (role, index) => (
                  <motion.span
                    key={index}
                    className="grain-inside px-4 max-[580px]:px-0 max-[580px]:text-xs max-[358px]:text-[10px] max-[578px]:w-full max-[578px]:text-center bg-[#f7f1eb]"
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    transition={{
                      duration: 1,
        ...
        <div className="flex w-full justify-between items-end max-[900px]:flex-col max-[900px]:items-center max-[900px]:gap-6 max-[578px]:items-stretch">
          <div className="text-left max-[900px]:w-full max-[900px]:text-center">
            <motion.p
              className="text-xl sm:text-2xl md:text-2xl lg:text-3xl xl:text-3xl text-gray-700 max-w-md plus-jakarta font-medium mx-auto"
          ...
          <motion.div
            className="px-6 py-3 border border-gray-500 rounded-lg text-lg text-center font-normal general-sans max-[900px]:mx-auto max-[500px]:mt-7"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
